...
const checkout = ({ cart, addCart, removeFromCart, subTotal }) => {
    return (
        <div className='container m-auto'>
            ...
            <div className='m-5'>
                ...
                <div className='sidebar w-full bg-gray-100 p-7 rounded-md shadow-sm '>
                ...
                <div className='button my-2'>
                    <Link href={'/'}><button className="flex mr-2  text-white bg-indigo-500 
                 border-0 p-2 focus:outline-none hover:bg-indigo-600 rounded text-sm"> Pay {subTotal} $</button> </Link>
                </div>
            </div>
        </div>
    );
